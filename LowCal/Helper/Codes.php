...
class Codes
{
	...
	const INTERNAL_CONFIG_UNSUPPORTED_FILE = 12;
	const INTERNAL_CONFIG_FILE_NOT_FOUND = 13;
	const INTERNAL_CONFIG_UNSUPPORTED_VALUE_TYPE = 14;
	const INTERNAL_CONFIG_FILE_CANNOT_LOCK = 15;
	...
	const ROUTING_ERROR_INVALID_ROUTE = 45;
	const ROUTING_ERROR_FILE_NOT_FOUND = 46;
